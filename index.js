...
function revertBackDialog() {
    if (menu_type === "encyclopedia") {
        ...
        document.getElementById("character-image-full-container").style.animation = 'none';
        document.getElementById("character-image-full-container").offsetHeight;
        document.getElementById("character-image-full-container").style.animation = ` anim-character-image-full-container-unshow .8s forwards`;
        setTimeout(() => {
            ...
            document.getElementById("character-image-full-container").style.display = "none";
        }, 1000);
    }
}
...
function showCharFull(num) {
    document.getElementById("character-image-full-container").style.animation = 'none';
    document.getElementById("character-image-full-container").offsetHeight;
    document.getElementById("character-image-full-container").style.animation = ` anim-character-image-full-container-show .8s forwards`;
    document.getElementById("character-image-full").src = `assets/character/character_full_image/character_image_${num}.png`;
    document.getElementById("character-image-full-container").style.display = "inline";
}
